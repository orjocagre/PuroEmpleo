           ...
           <div class="menu_perfil">
             <nav id="nav">
                <ul>
                   ...
                   <div id="caja_empresa"><p id="texto_info" >HOLA MUNDO.</p></div>

                    <div id="caja_ofertas"><p id="texto_info" >HELLO WORLD</p></div>

                    <div id="caja_calificacion"><p id="texto_info" >Calificanos segun tu experiencia</p>
